...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gewas.code'
        db.alter_column('pestileaks_gewas', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Gewas.code'
        db.alter_column('pestileaks_gewas', 'code', self.gf('django.db.models.fields.IntegerField')())
