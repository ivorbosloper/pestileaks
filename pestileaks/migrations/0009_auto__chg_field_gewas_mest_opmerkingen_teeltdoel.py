...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gewas.mest_opmerkingen_teeltdoel'
        db.alter_column('pestileaks_gewas', 'mest_opmerkingen_teeltdoel', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Gewas.mest_opmerkingen_teeltdoel'
        db.alter_column('pestileaks_gewas', 'mest_opmerkingen_teeltdoel', self.gf('django.db.models.fields.CharField')(max_length=100))
