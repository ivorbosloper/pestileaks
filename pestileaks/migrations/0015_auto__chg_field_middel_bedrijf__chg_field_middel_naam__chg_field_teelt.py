...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Middel.bedrijf'
        db.alter_column(u'pestileaks_middel', 'bedrijf', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Middel.naam'
        db.alter_column(u'pestileaks_middel', 'naam', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'TeeltDoel.naam'
        db.alter_column(u'pestileaks_teeltdoel', 'naam', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250))

        # Changing field 'ToepassingsMethode.naam'
        db.alter_column(u'pestileaks_toepassingsmethode', 'naam', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250))

    def backwards(self, orm):

        # Changing field 'Middel.bedrijf'
        db.alter_column(u'pestileaks_middel', 'bedrijf', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Middel.naam'
        db.alter_column(u'pestileaks_middel', 'naam', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'TeeltDoel.naam'
        db.alter_column(u'pestileaks_teeltdoel', 'naam', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))

        # Changing field 'ToepassingsMethode.naam'
        db.alter_column(u'pestileaks_toepassingsmethode', 'naam', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
    ...
    models = {
        ...
        u'pestileaks.middel': {
            ...
            'bedrijf': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'eenheid': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'naam': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
        ...
        u'pestileaks.teeltdoel': {
            ...
            'edi_code': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'naam': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'})
        },
