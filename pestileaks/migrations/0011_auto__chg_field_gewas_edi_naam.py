...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gewas.edi_naam'
        db.alter_column('pestileaks_gewas', 'edi_naam', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Gewas.edi_naam'
        db.alter_column('pestileaks_gewas', 'edi_naam', self.gf('django.db.models.fields.CharField')(max_length=50))
