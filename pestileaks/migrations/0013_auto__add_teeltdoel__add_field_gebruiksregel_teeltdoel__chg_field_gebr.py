...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeeltDoel'
        db.create_table(u'pestileaks_teeltdoel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('naam', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('edi_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'pestileaks', ['TeeltDoel'])

        # Adding field 'GebruiksRegel.teeltdoel'
        db.add_column(u'pestileaks_gebruiksregel', 'teeltdoel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pestileaks.TeeltDoel'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'GebruiksRegel.gewas'
        db.alter_column(u'pestileaks_gebruiksregel', 'gewas_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pestileaks.Gewas'], null=True))

        # Changing field 'GebruiksRegel.aantasting'
        db.alter_column(u'pestileaks_gebruiksregel', 'aantasting_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pestileaks.Aantasting'], null=True))

    def backwards(self, orm):
        # Deleting model 'TeeltDoel'
        db.delete_table(u'pestileaks_teeltdoel')

        # Deleting field 'GebruiksRegel.teeltdoel'
        db.delete_column(u'pestileaks_gebruiksregel', 'teeltdoel_id')


        # Changing field 'GebruiksRegel.gewas'
        db.alter_column(u'pestileaks_gebruiksregel', 'gewas_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pestileaks.Gewas']))

        # Changing field 'GebruiksRegel.aantasting'
        db.alter_column(u'pestileaks_gebruiksregel', 'aantasting_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pestileaks.Aantasting']))
