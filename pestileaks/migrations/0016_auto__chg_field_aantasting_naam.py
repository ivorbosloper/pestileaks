...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aantasting.naam'
        db.alter_column(u'pestileaks_aantasting', 'naam', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250))

    def backwards(self, orm):

        # Changing field 'Aantasting.naam'
        db.alter_column(u'pestileaks_aantasting', 'naam', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
